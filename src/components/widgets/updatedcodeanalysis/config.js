...
(function () {
    ...
    angular
        ...
        .controller('UpdatedCodeAnalysisConfigController', UpdatedCodeAnalysisConfigController);

    UpdatedCodeAnalysisConfigController.$inject = ['modalData', '$scope', 'collectorData', '$uibModalInstance'];
    function UpdatedCodeAnalysisConfigController(modalData, $scope, collectorData, $uibModalInstance) {
        var ctrl = this,
