(function () {
    ...
    angular
        ...
        .controller('UpdatedTestDetailsController', UpdatedTestDetailsController);

    UpdatedTestDetailsController.$inject = ['$scope','$uibModalInstance', 'testResult', 'DashStatus'];
    function UpdatedTestDetailsController($scope, $uibModalInstance, testResult, DashStatus) {
