(function () {
    ...
    angular
        ...
        .controller('UpdatedCodeAnalysisViewController', UpdatedCodeAnalysisViewController);

    UpdatedCodeAnalysisViewController.$inject = ['$scope', 'codeAnalysisData', 'testSuiteData', 'libraryPolicyData', '$q', '$filter', '$uibModal', '$interval'];

    function UpdatedCodeAnalysisViewController($scope, codeAnalysisData, testSuiteData, libraryPolicyData, $q, $filter, $uibModal, $interval) {
        var ctrl = this;
        ...
        function showLibraryPolicyDetails(type, data) {
            $uibModal.open({
                ...
                templateUrl: 'components/widgets/updatedcodeanalysis/librarypolicydetails.html',
                size: 'lg',
                resolve: {
